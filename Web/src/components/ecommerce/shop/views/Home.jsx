...
import Watches from "../images/banner/Watches.webp";
import Male from "../images/category/male.webp";
import Female from "../images/category/female.webp";
import SmartWatch from "../images/category/smartwatch.webp";
import Footwear from "../images/category/footwear.webp";
...
class HomeView extends Component {
	...
	render() {
		...
		const productRows = rows.map((row, idx) => iconProducts.slice(idx * 4, idx * 4 + 4));
					...
					{row.map((product, idx) => {
						...
						return (
							<div key={idx} className="col-md-3">
								...
								>
									<ProductImage
										className={product.cssClass + " mb-1"}
										height="3.5rem"
										width="3.5rem"
									/>
								</CardIcon>
				...
				<div className="container-fluid bg-light mb-3">
					<div className="row g-3">
						...
						<div className="col-md-3">
							...
							<CardImage src={Watches} to="promo" />
						</div>
					</div>
				</div>
				<div className="container-fluid bg-light mb-3">
